        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-3 text-sm text-[#cbbca1]">
              <a href={`mailto:${venueDetails.email}`} className="inline-flex items-center gap-2 hover:text-[#a98f63] transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="2" y="4" width="20" height="16" rx="2" />
                  <path d="M2,4 12,13 22,4" />
                </svg>
                {venueDetails.email}
              </a>
              <a href={`tel:${venueDetails.phone.replace(/\s/g, "")}`} className="inline-flex items-center gap-2 hover:text-[#a98f63] transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 hover:text-[#a98f63] transition-colors"
              >
