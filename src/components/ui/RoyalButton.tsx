...
export const RoyalButton = ({ href, children, variant = "primary", type = "button", onClick, disabled, target, rel }: { href?: string; children: React.ReactNode; variant?: "primary" | "outline"; type?: "button" | "submit"; onClick?: () => void; disabled?: boolean; target?: string; rel?: string; }) => {
